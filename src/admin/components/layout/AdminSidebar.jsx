    ...
    const isActive =
      ...
      (location.pathname.startsWith(item.href) &&
        (item.href !== "/admin/products" ||
          !location.pathname.startsWith("/admin/products/featured")) &&
        ...
        <span
          ...
          className={cn(
            ...
            !isCollapsed || isMobile
              ? "w-auto opacity-100 ml-3 delay-100"
              : "hidden",
          )}
        >
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center text-center gap-2 relative z-10 transition-all duration-300">
          ...
          <div
            className={cn(
              ...
              !isCollapsed || isMobile
                ? "w-45 opacity-100 ml-0 delay-100"
                : "w-0 opacity-0",
            )}
          >
      ...
      <div
        ...
        className="flex-1 overflow-y-auto py-2 px-3 space-y-2 scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-transparent"
      >
        {navigation.map((item) => (
      ...
      <div
        style={{ padding: "5px" }}
        className="w-full flex justify-center items-center text-center border-t border-slate-800/50 p-4 bg-linear-to-t from-slate-950 to-transparent"
      >
        <button
