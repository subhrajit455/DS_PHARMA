...
const CustomerDetails = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-emerald-100 to-emerald-50 p-6">
      <div className="mx-auto max-w-5xl space-y-6">
        ...
        {/* Header Profile */}
        <Card className="p-6 bg-white/80 backdrop-blur-sm border border-emerald-100">
          <CardContent className="p-0 flex flex-col md:flex-row items-center md:items-start gap-6">
            ...
            <div className="flex gap-8 md:border-l border-gray-100 md:pl-8 pt-4 md:pt-0">
              <div className="text-center">
                ...
                <p className="text-xl font-bold text-gray-900">{customer.orders ?? 0}</p>
              </div>
              <div className="text-center">
                <p className="text-sm text-gray-500 mb-1">Total Spent</p>
                <p className="text-xl font-bold text-emerald-600">₹{Number(customer.totalSpent || 0).toLocaleString('en-IN')}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="lg:col-span-2">
           <Card>
             ...
             <CardContent className="p-0">
               <Table>
                 <TableHeader>
                   <TableRow className="bg-gradient-to-r from-emerald-50 to-emerald-100">
                 ...
                 <TableBody>
                   {customer.recentOrders?.map((order) => (
                     <TableRow key={order.id} className="hover:bg-emerald-50/50">
                       ...
                       <TableCell className="font-bold text-gray-900">₹{Number(order.total || 0).toLocaleString('en-IN')}</TableCell>
                       <TableCell>
