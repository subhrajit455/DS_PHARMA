...
function buildGSTRows(products) {
  ...
  for (const p of products) {
    ...
    if (!map[key])
      map[key] = { gst: gstPct, total: 0, disc: 0, sgst: 0, cgst: 0 };
      ...
      <Page size="A4" style={s.page}>
        ...
        <View style={s.metaRow}>
          ...
          <View style={s.metaLeft}>
            ...
            {customer.Address ? (
              <Text style={s.metaVal}>{customer.Address}</Text>
            ) : null}
            {customer.CustMobile ? (
          ...
          <View style={s.metaRight}>
            ...
            <View style={s.metaRow2}>
              ...
              <Text style={[s.metaData, s.bold]}>
                : {payLabel(payment.paymentmode)}
              </Text>
            </View>
            <View style={s.metaRow2}>
            ...
            <View style={s.metaRow2}>
              ...
              <Text style={s.metaData}>: {order.Sid || "—"}</Text>
            </View>
          </View>
        </View>
          ...
          {products.map((p, i) => {
            ...
            return (
              <View key={p._id || i} style={isLast ? s.tRowLast : s.tRow}>
                ...
                <View style={s.cAmt}>
                  <Text style={[s.td, { textAlign: "right" }]}>
                    {(Number(p.Rate || 0) + Number(p.taxAmount || 0)).toFixed(
                      2,
                    )}
                  </Text>
                </View>
        ...
        <View style={s.pageFooter} fixed>
          <Text style={s.pageFooterText}>
            {FIRM.name} — Computer generated document. All disputes subject to
            Jurisdiction only.
          </Text>
          <Text style={s.pageFooterText}>
