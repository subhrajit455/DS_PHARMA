...
export const IMAGE_LIBRARY = {
  ...
  device_thermometer:
    "https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?auto=format&fit=crop&w=800&q=80", // Medical generic
  device_oximeter:
    "https://images.unsplash.com/photo-1615486511484-92e1017d36d7?auto=format&fit=crop&w=800&q=80", // Oximeter
  device_glucometer:
...
export const CATEGORY_DETAILS = [
  {
    id: 1,
    name: "Fever & Pain",
    image: IMAGE_LIBRARY.pills_white_blister,
    alt: "Fever and Pain Relief",
  },
  {
    id: 2,
    name: "Antibiotics",
    image: IMAGE_LIBRARY.capsules_red,
    alt: "Antibiotic Medicines",
  },
  {
    id: 3,
    name: "Vitamins & Supplements",
    image: IMAGE_LIBRARY.capsules_orange,
    alt: "Daily Vitamins",
  },
  {
    id: 4,
    name: "Diabetes Care",
    image: IMAGE_LIBRARY.device_glucometer,
    alt: "Diabetes Management",
  },
  {
    id: 5,
    name: "Skin Care",
    image: IMAGE_LIBRARY.tube_white,
    alt: "Skin Health",
  },
  {
    id: 6,
    name: "Stomach Care",
    image: IMAGE_LIBRARY.bottle_amber,
...
export const PRODUCTS = [
  ...
  },
  {
    ...
    isFeatured: true,
    isVisible: false,
    image: IMAGE_LIBRARY.pills_colored_mix,
    description:
  ...
  // Vitamins
  {
    ...
    isFeatured: true,
    isVisible: true,
    image: IMAGE_LIBRARY.pills_blue_bottle,
    description:
  ...
  // Stomach Care
  {
    ...
    prescriptionRequired: true,
    inStock: true,
    image: IMAGE_LIBRARY.capsules_blue,
    description:
  ...
  },
  {
    ...
    prescriptionRequired: false,
    inStock: true,
    image: IMAGE_LIBRARY.bottle_dropper,
    description:
  ...
  },
  {
    ...
    prescriptionRequired: false,
    inStock: true,
    image: IMAGE_LIBRARY.first_aid_kit,
    description:
  ...
  },
  {
    ...
    prescriptionRequired: false,
    inStock: true,
    image: IMAGE_LIBRARY.device_thermometer,
    description:
  ...
  },
  {
    ...
    prescriptionRequired: false,
    inStock: true,
    image: IMAGE_LIBRARY.device_oximeter,
    description:
  ...
  },
  {
    ...
    prescriptionRequired: false,
    inStock: true,
    image: IMAGE_LIBRARY.device_bp, // Using generic device image
    description:
  ...
  },
  {
    ...
    prescriptionRequired: false,
    inStock: true,
    image: IMAGE_LIBRARY.device_glucometer, // Placeholder for test kit
    description:
  ...
  },
  {
    ...
    prescriptionRequired: false,
    inStock: true,
    image: IMAGE_LIBRARY.baby_care, // Placeholder
    description:
  ...
  },
  {
    ...
    prescriptionRequired: false,
    inStock: true,
    image: IMAGE_LIBRARY.nutrition_powder,
    description:
