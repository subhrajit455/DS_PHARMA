...
const SocialLogin = () => {
    ...
    return (
        <div className="mt-6" style={{ padding: '5px 10px' }}>
            ...
            <div className="mt-6 grid grid-cols-2 gap-3" style={{ margin: '10px' }}>
                <Button
                    variant="outline"
                ...
                >
                    ...
                    <p style={{ padding: '0px 5px',marginTop:'3px' }}>Google</p>
                </Button>
                ...
                >
                    ...
                    <p style={{ padding: '0px 5px',marginTop:'3px' }}>Facebook</p>
                </Button>
            </div>
        </div>
    );
