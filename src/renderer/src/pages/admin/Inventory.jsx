                ...
                <Table>
                  <TableHeader className="sticky top-0 bg-muted z-10 shadow-sm">
                    <TableRow>
                      ...
                      <TableHead className="bg-muted">MRP</TableHead>
                      <TableHead className="bg-muted">Rate</TableHead>
                      <TableHead className="bg-muted">P.Rate</TableHead>
                      <TableHead className="text-center bg-muted">Stock</TableHead>
                      <TableHead className="text-center bg-muted">Deal</TableHead>
                  ...
                  <TableBody>
                    {products.map((product) => (
                      <TableRow key={product._id}>
                        ...
                        <TableCell>₹{parseFloat(product.Rate || 0).toFixed(2)}</TableCell>
                        <TableCell>₹{parseFloat(product.PRate || 0).toFixed(2)}</TableCell>
